        ...
        <section className="py-20 bg-zinc-800">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 id="location" className="text-4xl md:text-5xl font-bold text-white mb-4">
                        Nossa <span className="text-yellow-400">Localização</span>
                    </h2>
                    <p className="text-gray-300 text-lg max-w-2xl mx-auto">
                        Venha nos visitar! Estamos prontos para cuidar do seu visual com todo carinho e profissionalismo.
                    </p>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="bg-zinc-900 p-8 rounded-lg shadow-xl border border-zinc-700 flex flex-col">
                        ...
                        <a className="block w-full bg-yellow-400 hover:bg-yellow-700 text-white text-center py-3 rounded-full mt-auto"
                            href="https://api.whatsapp.com/send/?phone=556899998899&text=Olá%20gostaria%20de%20agendar%20um%20horário&type=phone_number&app_absent=0" target="_blank">
